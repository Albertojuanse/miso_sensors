//
//  ViewControllerModellingRhoRhoLocating.m
//  Sensors test
//
...
@implementation ViewControllerModellingRhoRhoLocating
...
- (void)viewDidLoad
{
    ...
    if (!rhoRhoSystem) {
        NSLog(@"[ERROR][VCMRTM] Component 'rhoRhoSystem' not found when loading view.");
    }
    if (!location) {
...
{
    [self performSegueWithIdentifier:@"fromModellingRHO_RHO_LOCATINGToRHO_RHO_LOCATING" sender:sender];
}
...
- (IBAction)handleBackFinish:(id)sender
{
    ...
    [self performSegueWithIdentifier:@"fromModellingRHO_RHO_LOCATINGToFinalModel" sender:sender];
}
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    ...
    if ([[segue identifier] isEqualToString:@"fromModellingRHO_RHO_LOCATINGToRHO_RHO_LOCATING"]) {
        ...
        [viewControllerRhoRhoLocating setDeviceUUID:deviceUUID];
        return;
    }
    if ([[segue identifier] isEqualToString:@"fromModellingRHO_RHO_LOCATINGToFinalModel"]) {
