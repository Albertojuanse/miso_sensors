                       ...
                       ofTableItems:(UITableView *)tableView
{
    ...
    if (savedItem) {
        ...
        if (savedItemDic) {
            ...
            NSLog(@"[ERROR]%@ New position %@ could not be stored as an item.", infoDic[@"position"], ERROR_DESCRIPTION_VCETTM);
        }
        [sharedData inSessionDataSetAsNotChosenItem:itemDic
                                  toUserWithUserDic:userDic
                             withCredentialsUserDic:credentialsUserDic];
...
@discussion This method returns the image for measuring interface in thetaThetaModelling mode to measure the selected item.
*/
                    ...
                    toMeasureItemDic:(NSMutableDictionary *)itemDic
{
        ...
        )
    {
        ...
        if (itemDic) {
            ...
            NSMutableDictionary * dataDic = [[NSMutableDictionary alloc] init];
            dataDic[@"itemDic"] = itemDic;
            NSLog(@"[NOTI]%@ Notification \"lmdThetaThetaModelling/start\" posted.", ERROR_DESCRIPTION_VCETTM);
            [[NSNotificationCenter defaultCenter] postNotificationName:@"lmdThetaThetaModelling/start"
                                                                object:nil
                                                              userInfo:dataDic];
        ...
        )
    {
        ...
        NSLog(@"[NOTI]%@ Notification \"lmdThetaThetaModelling/stop\" posted.", ERROR_DESCRIPTION_VCETTM);
        [[NSNotificationCenter defaultCenter] postNotificationName:@"lmdThetaThetaModelling/stop"
                                                            object:nil];
