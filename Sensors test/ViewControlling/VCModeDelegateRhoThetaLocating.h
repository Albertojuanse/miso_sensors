//
//  VCModeDelegateRhoThetaLocating.h
//  Sensors test
//
...
static NSString * ERROR_DESCRIPTION_VCERTL = @"[VCERTL]";
static NSString * IDLE_STATE_MESSAGE_VCERTL = @"IDLE; please, aim the iBeacon device and tap 'Measure' for starting. Tap back for finishing.";
static NSString * MEASURING_STATE_MESSAGE_VCERTL = @"MEASURING; please, do not move the device. Tap 'Measure' again for finishing measure.";

/*!
 @class VCModeDelegateRhoThetaLocating
 @discussion This class implements the protocol VCModeDelegate to define the behaviour of the editing view controller in RhoThetaLocating mode.
 */
@interface VCModeDelegateRhoThetaLocating: NSObject<VCModeDelegate>{
    ...
    LMDelegateRhoThetaLocating * location;
